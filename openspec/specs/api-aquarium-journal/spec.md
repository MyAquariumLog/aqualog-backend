# api-aquarium-journal Specification

## Purpose
Define authenticated API behavior for recording, retrieving, updating, and deleting free-text journal entries against a user-owned aquarium, including ownership scoping, privacy, payload validation/defaulting, and response shape.
